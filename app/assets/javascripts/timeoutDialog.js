...
function timeoutDialog(options) {
  ...
  var localisedDefaults = readCookie('PLAY_LANG') && readCookie('PLAY_LANG') === 'cy' && {
    title: undefined,
    message: 'Am resymau diogelwch, cewch eich allgofnodi o’r gwasanaeth hwn ymhen:',
  ...
  function setupDialog() {
    ...
    var $element = $('<div>')
      .append(settings.title ? $('<h2 class="govuk-heading-m push--top">').text(settings.title) : '')
