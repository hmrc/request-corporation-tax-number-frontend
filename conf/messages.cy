...
index.useForm.title = Ni fyddwch yn gallu gwneud cais am gopi o UTR Treth Gorfforaeth ar gyfer cwmnïau sydd:
...
index.beforeYouStart.heading = Cyn i chi ddechrau
...
session_expired.guidance = Er eich diogelwch, rydym wedi clirio'ch manylion oherwydd nid ydych wedi gwneud unrhyw beth am 15 munud.
...
companyDetails.checkYourAnswersLabel = Manylion eich cwmni
...
error.pageNotFound.title = Heb ddod o hyd i'r dudalen – Gofynnwch am gopi o'ch UTR Treth Gorfforaeth – GOV.UK
error.pageNotFound.heading = Heb ddod o hyd i'r dudalen
